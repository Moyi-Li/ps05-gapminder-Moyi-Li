...
b)  Similarly, for most of the iso3 and name, it is 1 to 1 matched. However, there is the NA (Missing values) in iso3 codes that correspond to 4 names for countries.
...
region_barplot
ggsave("Average CO2 Emissions per Capita for 5 Continents.png", region_barplot, width = 10, height = 6)

```

6. Because 2019 data is missing, I'll take 2016 in this problem.
...
2. This plot used 2019 data instead.
...
8. In the relative ranking table, I found that US ranking's decreases is not that immediate.
